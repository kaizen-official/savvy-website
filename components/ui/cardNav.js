        ...
        >
            ...
            >
                <div className="card-nav-top absolute inset-x-0 top-0 h-15 flex items-center justify-between p-2 pl-[1.1rem] z-2">
                    ...
                    <div className="logo-container rounded-lg flex items-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 order-1 md:order-0">
                        <img src={logo} alt={logoAlt} className="logo h-15" />
                    </div>
                ...
                >
                    {(items || []).slice(0, 3).map((item, idx) => (
                        ...
                        >
                            <div className="nav-card-label font-normal tracking-[-0.5px] text-2xl">
                                {item.label}
                            </div>
                            <div className="nav-card-links mt-auto flex flex-col gap-0.5">
                                {item.links?.map((lnk, i) => (
                                    <a
                                        key={`${lnk.label}-${i}`}
                                        className="nav-card-link inline-flex items-center gap-1.5 no-underline cursor-pointer transition-opacity duration-300 hover:opacity-75 text-lg"
                                        href={lnk.href}
